 ...
 *
 */
public class ActivityLoadMap extends Activity implements MKOfflineMapListener{
    ...
    public class LocalMapAdapter extends BaseAdapter {
        ...
        public View getView(int index, View view, ViewGroup arg2) {
            ...
            view = View.inflate(ActivityLoadMap.this,R.layout.offline_localmap_list, null);
            initViewItem(view, e);
            return view;
        }
        ...
        void initViewItem(View view, final MKOLUpdateElement e) {
            ...
            display.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.setClass(ActivityLoadMap.this, BaseMap.class);
