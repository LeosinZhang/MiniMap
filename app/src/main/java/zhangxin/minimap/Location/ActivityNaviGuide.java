 ...
 *
 */
public class ActivityNaviGuide extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ActivityNavigation.activityList.add(this);
		createHandler();
		...
		if (intent != null) {
			...
			if (bundle != null) {
			    mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(ActivityNavigation.ROUTE_PLAN_NODE);
	...
	protected void onDestroy() {
		...
		ActivityNavigation.activityList.remove(this);
		super.onDestroy();
	}
