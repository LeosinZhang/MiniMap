...
public class WriteLog {
	private static com.baidu.location.service.WriteLog instance = null;
	private File file = null;
	private FileWriter writer;
	private final String LOG_PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + "/loc.log";
	private String timeStr = null;

	public static com.baidu.location.service.WriteLog getInstance() {
		if (instance == null)
			instance = new com.baidu.location.service.WriteLog();
		return instance;
	}
